...
export class FeedbackComponent implements OnInit,AfterViewInit {
  ...
  defaultImageUrl = ''; // Update with your actual placeholder path

  // Define placeholder image path
  placeholderImage = 'https://www.shutterstock.com/image-vector/car-logo-icon-emblem-design-600nw-473088025.jpg';
