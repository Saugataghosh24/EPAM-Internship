...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function initSlider() {
        ...
        dots.forEach((dot) => {
            dot.addEventListener('click', function () {
                const slideIndex = parseInt(this.getAttribute('data-index') || '0');
    ...
    function initializeSearch() {
        ...
        searchInput.addEventListener('input', function () {
            ...
            const filteredResults = destinations.filter(destination => destination.name.toLowerCase().includes(query) ||
    ...
    document.addEventListener('click', function (e) {
        ...
        if (target.closest('#search-button')) {
            ...
            const activeTab = activeTabElement ? activeTabElement.id : 'tours';
            ...
            if (activeTab === 'tickets') {
                ...
                if (!selectedDestId) {
                    ...
                    const matchingDestinations = destinations.filter(dest => dest.name.toLowerCase() === query || // Exact match
            ...
            setTimeout(() => {
                ...
                if (selectedDestId) {
                    ...
                    const query = locationInput.value.toLowerCase().trim();
                    filteredDestinations = destinations.filter(dest => dest.name.toLowerCase().includes(query) ||
    ...
    function createResultsSection() {
        ...
        if (heroSection) {
            (_a = heroSection.parentNode) === null || _a === void 0 ? void 0 : _a.insertBefore(resultsSection, heroSection.nextSibling);
                    ...
                    cardContent = `
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-3 flex flex-wrap gap-1">
                                ${destination.activities ? destination.activities.map((activity) => `<span class="inline-block bg-gray-100 rounded-full px-2 py-1 text-xs font-semibold text-gray-700">${activity}</span>`).join('') : ''}
                            </div>
                ...
                case 'activities':
                    cardContent = `
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-3 flex flex-wrap gap-1">
                                ${destination.activities ? destination.activities.slice(0, 3).map((activity) => `<span class="inline-block bg-gray-100 rounded-full px-2 py-1 text-xs font-semibold text-gray-700">${activity}</span>`).join('') : ''}
